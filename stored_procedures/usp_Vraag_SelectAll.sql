...
BEGIN  
	...
	BEGIN TRY
		...
		SELECT V.VRAAG_NAAM, V.VRAAG_TITEL, TBV.THEMA, VO.VRAAGSOORT, COUNT(VRAAGONDERDEELNUMMER) AS Aantal_onderdelen
		...
		GROUP BY V.VRAAG_NAAM, V.VRAAG_TITEL, TBV.THEMA, VO.VRAAGSOORT
