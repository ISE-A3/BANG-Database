...
CREATE or ALTER PROCEDURE dbo.usp_AlleAntwoordenVanAlleVraagonderdelenVanVraag_Delete
	@VRAAG_NAAM VARCHAR(256)
AS
BEGIN  
	DECLARE @savepoint varchar(128) = CAST(OBJECT_NAME(@@PROCID) as varchar(125)) + CAST(@@NESTLEVEL AS varchar(3))
	...
	BEGIN TRY
		...
		IF NOT EXISTS (
			...
			THROW 50008, 'Er bestaan geen antwoorden voor de vraagonderdelen van deze vraag', 1
